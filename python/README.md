...
## DevSecOps Tools Used in This Project

- SCA: Safety, pip-audit, Trivy (filesystem/dependencies)
- SAST: Semgrep, Pylint, Flake8
- DAST: OWASP ZAP baseline
- Secret scanning: Gitleaks, TruffleHog
- Container scanning: Trivy image scan
- Code scanning: CodeQL (separate workflow)
...
- `.github/workflows/python-hadolint.yml`
